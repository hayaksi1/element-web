    ...
    public emitUpdateIfStateChanged = (state: SyncState, forceEmit: boolean): void => {
        ...
        for (const room of visibleRooms) {
            if (isRoomVisible(room)) {
                ...
                // themselves. Its mere activity is therefore left out too. Anything louder than
