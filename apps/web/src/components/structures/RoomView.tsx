...
function searchInfoFromSession(session: SearchSession): SearchInfo {
    return {
        ...
        // re-search does not silently revert to recency (search Phase 5 slice 1).
        order: session.order,
...
export class RoomView extends React.Component<IRoomProps, IRoomState> {
    ...
    private onRoomViewStoreUpdate = async (initial?: boolean): Promise<void> => {
        ...
        // queued jump then tripped the gate ("the search resets itself", search Phase 8c). A welcome corollary:
    ...
    // Re-run the active search with a new `from:`/sender filter (search Phase 3 slice 2), keeping the current
    ...
    // Re-run the active search with a new result order (recent/relevant) (search Phase 5 slice 1), keeping the
