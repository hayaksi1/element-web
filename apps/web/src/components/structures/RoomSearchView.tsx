...
interface Props {
     ...
     * search Phase 7) can load the next page on demand. Called with a function that loads the next result page
...
export const RoomSearchView = ({
    ...
    // next page when it is scrolled to the bottom (search Phase 7); deregistered on unmount.
    useEffect(() => {
