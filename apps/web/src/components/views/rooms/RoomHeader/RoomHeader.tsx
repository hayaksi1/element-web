...
/**
 * The room header's trailing actions: search, calls, threads, notifications, room info and the
 * member face pile. Exported so a thread shown in place of the room timeline can carry the same
