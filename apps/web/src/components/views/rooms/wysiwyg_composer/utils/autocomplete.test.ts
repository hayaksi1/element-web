...
import { buildQuery, getRoomFromCompletion, getMentionDisplayText, getMentionAttributes } from "./autocomplete";
import * as _mockAvatar from "../../../../../Avatar";
...
describe("getMentionAttributes", () => {
    ...
    const mockAvatar = vi.mocked(_mockAvatar);
