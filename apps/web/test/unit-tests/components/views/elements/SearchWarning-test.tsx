 ...
 * `checkpointedRooms()` (the rooms with outstanding crawler checkpoints), `isRoomIndexed()`
 * (whether the index holds any events for a room) and the `changedCheckpoint` emitter.
 */
