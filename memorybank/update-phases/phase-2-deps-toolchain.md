...
> **Risk: MEDIUM. Goal:** lock in the dependency + toolchain story *before* the bulk merge, so the merged tree compiles
...
- The dependency/lockfile *procedure* is staged for Phase 3 (this phase decides; Phase 3 executes the merge that pulls
